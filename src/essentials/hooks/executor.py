...
from essentials.api.client import ApiMessageCompleteEvent, ApiMessageRequest, SupportsStreamingMessages
from essentials.engine.messages import ConversationMessage
from essentials.hooks.events import HookEvent
from essentials.hooks.loader import HookRegistry
from essentials.hooks.schemas import (
    AgentHookDefinition,
...
from essentials.hooks.types import AggregatedHookResult, HookResult
from essentials.sandbox import SandboxUnavailableError
...
class HookExecutor:
    ...
    async def _run_command_hook(
        ...
        try:
            process = await create_shell_subprocess(
                ...
                env={
                    **os.environ,
                    "ESSENTIALS_HOOK_EVENT": event.value,
                    "ESSENTIALS_HOOK_PAYLOAD": json.dumps(payload),
                },
            )
    ...
    async def _run_prompt_like_hook(
        ...
        *,
        ...
        prefix = (
            "You are validating whether a hook condition passes in Essentials. "
