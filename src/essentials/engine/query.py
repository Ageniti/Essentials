...
from essentials.api.client import (
...
from essentials.config.paths import get_data_dir
...
from essentials.services.tool_outputs import tool_output_inline_chars, tool_output_preview_chars
from essentials.tools.base import ToolExecutionContext
...
def _remember_async_agent_activity(
    ...
    *,
    ...
    if tool_name == "agent":
        ...
        target = str(tool_input.get("to") or "").strip()
...
async def run_query(
    ...
    """
    from essentials.services.compact import (
        AutoCompactState,
