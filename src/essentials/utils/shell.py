...
from essentials.config import Settings, load_settings
from essentials.platforms import PlatformName, get_platform
from essentials.sandbox import wrap_command_for_sandbox
...
async def create_shell_subprocess(
    ...
    *,
    ...
    if resolved_settings.sandbox.enabled and resolved_settings.sandbox.backend == "docker":
        from essentials.sandbox.session import get_docker_sandbox
