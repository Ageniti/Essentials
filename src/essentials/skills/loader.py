...
from essentials.config.settings import load_settings
from essentials.skills._frontmatter import (
    optional_frontmatter_str,
    parse_bool_frontmatter,
    parse_skill_frontmatter,
    parse_skill_metadata,
)
from essentials.skills.bundled import get_bundled_skills
from essentials.skills.registry import SkillRegistry
...
def load_skill_registry(
    ...
    *,
    ...
    for skill in load_skills_from_dirs(extra_skill_dirs):
        registry.register(skill)
    if cwd is not None:
        from essentials.plugins.loader import load_plugins
