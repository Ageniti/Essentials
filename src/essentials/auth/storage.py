"""Credential storage for Essentials.

Default backend: ~/.essentials/credentials.json with mode 600.
...
def _obfuscation_key() -> bytes:
    ...
    seed = str(Path.home()).encode() + b"essentials-v1"
    import hashlib
