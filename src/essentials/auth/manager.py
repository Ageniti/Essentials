"""Unified authentication manager for Essentials providers."""
...
# Providers that Essentials knows about.
_KNOWN_PROVIDERS = [
    "anthropic",
    "openai",
    "dashscope",
...
class AuthManager:
    ...
    Reads/writes credentials via :mod:`essentials.auth.storage` and keeps
    ...
    def save_settings(self) -> None:
        ...
        from essentials.config import save_settings
