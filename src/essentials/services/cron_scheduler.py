...
Runs as a standalone process (``essentials cron start``) or can be embedded via
...
from essentials.config.paths import get_data_dir, get_logs_dir
from essentials.services.cron import (
    load_cron_jobs,
    mark_job_run,
...
# ---------------------------------------------------------------------------
# Daemon entry point (spawned by ``essentials cron start``)
# ---------------------------------------------------------------------------
