...
from essentials.config.paths import get_sessions_dir
from essentials.engine.messages import ConversationMessage, sanitize_conversation_messages
...
def save_session_snapshot(
    *,
    ...
    payload = {
        ...
        "session_mode": _sanitize_metadata((tool_metadata or {}).get("session_mode", "default")),
        "created_at": now,
        "summary": summary,
...
def export_session_markdown(
    *,
    ...
    parts: list[str] = ["# Essentials Session Transcript"]
