...
from essentials.services import session_storage
...
class EssentialsSessionBackend:
    """Default session backend backed by ``~/.essentials/data/sessions``."""
...
DEFAULT_SESSION_BACKEND: SessionBackend = EssentialsSessionBackend()
