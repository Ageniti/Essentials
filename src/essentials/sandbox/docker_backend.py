...
from essentials.platforms import get_platform, get_platform_capabilities
from essentials.sandbox.adapter import SandboxAvailability, SandboxUnavailableError
...
class DockerSandboxSession:
    """Manages a long-running Docker container for one Essentials session."""
    ...
    def __post_init__(self) -> None:
        self._container_name = f"essentials-sandbox-{self.session_id}"
    ...
    def _build_run_argv(self) -> list[str]:
        ...
        # egress to unrestricted container networking.
    ...
    async def start(self) -> None:
        ...
        from essentials.sandbox.docker_image import ensure_image_available
