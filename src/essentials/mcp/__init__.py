...
if TYPE_CHECKING:  # pragma: no cover
    from essentials.mcp.client import McpClientManager, McpServerNotConnectedError
    from essentials.mcp.types import (
        McpConnectionStatus,
        McpHttpServerConfig,
        McpJsonConfig,
        McpResourceInfo,
...
def __getattr__(name: str):
    ...
    if name == "McpServerNotConnectedError":
        from essentials.mcp.client import McpServerNotConnectedError
